...
import { WhitelistFormWrapper } from "./WhitelistFormWrapper";
    ...
    <section id="join" className="relative py-8 md:py-12 hidden md:block" aria-label="قسم الانضمام">
      <div className="container mx-auto px-4 sm:px-6">
        <div className="mx-auto max-w-4xl">
          <div className="absolute inset-x-0 top-1/2 -translate-y-1/2 mx-auto h-64 w-full max-w-lg rounded-full bg-linear-to-r from-primary/15 via-accent/15 to-primary/5 blur-3xl" />

          <div className="relative overflow-hidden rounded-3xl border border-foreground/10 bg-background/60 backdrop-blur-2xl backdrop-saturate-150 shadow-2xl shadow-primary/10">
            ...
            <div className="p-8 sm:p-10 md:p-12 relative z-10">
              <div className="mb-4 text-center">
                <div className="mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-linear-to-br from-primary to-accent shadow-lg shadow-primary/30 ring-2 ring-primary/20">
                ...
                <div className="mt-4 inline-flex items-center gap-2 rounded-full border border-primary/20 bg-primary/10 backdrop-blur-sm px-4 py-1.5 text-xs font-medium text-primary dark:text-primary">
                  <CheckCircle2 className="h-3.5 w-3.5" />
                  <span>مجاني تماماً • بدون بطاقة ائتمان</span>
                </div>
              </div>

              <WhitelistFormWrapper />
